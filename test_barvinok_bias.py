...
def summary_stats_random_c(n, vector_set, randomness='binomial'):
    '''
    generate random c in {-1,1}^n or gaussian, compute <c,y> for all y in vector_set. 
    ...
    for y in vector_set:
        ...
        scaled_dot_product = np.log(2)*dot_product(c,y)
...
#    plot_histogram(gumbel_maxs, "gumbel_max", np.log(Z), n, trials)
#    plot_histogram(gumbel_medians, "gumbel_median", np.log(Z), n, trials)
#    plot_histogram(gumbel_means, "gumbel_mean", np.log(Z), n, trials)
#    plot_histogram(gumbel_stdvs, "gumbel_stdv", np.log(Z), n, trials)
#
    plot_histogram(barvinok_maxs, "barvinok_max", np.log(Z), n, trials)
    plot_histogram(barvinok_medians, "barvinok_median", np.log(Z), n, trials)
    plot_histogram(barvinok_means, "barvinok_mean", np.log(Z), n, trials)
    plot_histogram(barvinok_stdvs, "barvinok_stdv", np.log(Z), n, trials)

####    plot_histogram2(barvinok_maxs, gumbel_maxs, "max", np.log(Z), n, trials, random)
####    plot_histogram2(barvinok_medians, gumbel_medians, "median", np.log(Z), n, trials, random)
####    plot_histogram2(barvinok_means, gumbel_means, "mean", np.log(Z), n, trials, random)
####    plot_histogram2(barvinok_stdvs, gumbel_stdvs, "stdv", np.log(Z), n, trials, random)
